...
# 读取excel信息
read_excelFile = "/Users/weiyi/Desktop/深圳上市公司信息表.xlsx"
read_excelSheet = "微信号(智慧1)"
read_excelRow = 955
read_excelColumn = 7
...
# 关闭并清除已打开的微信进程和终端进程
os.system('adb -s cf84ffc3 shell am force-stop com.tencent.mm')
os.system('adb -s cf84ffc3 shell am force-stop jackpal.androidterm')
time.sleep(5)
...
desired_caps = {"platformName": "Android", "platformVersion": "10", "deviceName": "oneplus1",
                "udid": "cf84ffc3", "appPackage": "com.tencent.mm", "appActivity": "com.tencent.mm.ui.LauncherUI",
...
try:
    # 点击通讯录按钮
    os.system('adb -s cf84ffc3 shell input tap 417 2260')
    ...
    for value in publicIds:  # 获取搜索id
        ...
        os.system('adb -s cf84ffc3 shell input tap 997 170')
        time.sleep(3)
        ...
        if "没有更多的搜索结果" in source:
            if "公众号" in source:
                # 点击搜索的第一个结果
                os.system('adb -s cf84ffc3 shell input tap 798 513')
                time.sleep(5)
                ...
                if "不再关注" in source:
                    ...
                    os.system('adb -s cf84ffc3 shell input tap 30 165')
                    time.sleep(5)

                    os.system('adb -s cf84ffc3 shell input tap 34 168')
                    time.sleep(5)
                    ...
                    time.sleep(3)
                    os.system('adb -s cf84ffc3 shell input tap 548 634')
                    time.sleep(5)
                    ...
                    if "操作过于频繁，请稍后再试。" in source:
                        ...
                        # 停留随机的时间后再次循环搜索添加
                        sleepTime = random.randrange(30, 70)
