...
values=[]
with open('/Users/weiyi/pythonProject1/appiumWechat/data_open.txt','r') as f:
 for line in f:
...
desired_caps["deviceName"]="OnePlus8"
...
for value in values:
    ...
    el7 = driver.find_element_by_xpath('//*[@resource-id="com.tencent.mm:id/jc"]')
    el7.click()
    driver.implicitly_wait(10)
